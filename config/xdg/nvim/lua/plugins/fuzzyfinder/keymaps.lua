  ...
  },
  {
    ...
    function()
      require('plugins.fuzzyfinder.commands').find_files({
        ...
        prompt_title = 'git: list modified files',
      })
    end,
    silent = true,
    desc = 'telescope: git list modified files',
  },
  {
    '<leader>fgc',
    function()
      require('plugins.fuzzyfinder.commands').find_files({
        find_command = { 'git', 'diff', '--name-only', '--relative', '--cached' },
        prompt_title = 'git: list cached files',
      })
    end,
    silent = true,
    desc = 'telescope: git list cached files',
  },
  {
    '<leader>frr',
    function()
