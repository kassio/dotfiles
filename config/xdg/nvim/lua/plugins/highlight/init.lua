...
local reloadTheme = function(bg)
  return function()
    ...
    R('plugins.hbar.components.code-location')
    R('plugins.hbar.components.diagnostics')
    R('plugins.hbar.components.filename')
    R('plugins.hbar.components.git-branch')
    R('plugins.hbar.components.git-status')
    R('plugins.hbar.components.mode')
    R('plugins.hbar.statusline')
    R('plugins.hbar.tabline')
    R('plugins.hbar.winbar')
